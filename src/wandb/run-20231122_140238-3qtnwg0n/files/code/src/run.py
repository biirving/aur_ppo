...
if __name__=='__main__':
	...
	parser.add_argument('-t', '--total_timesteps', type=int, help='Total number of timesteps that we will take', default=1000)
	...
	parser.add_argument('-tri', '--trials', type=int, help='Number of trials to run', default=10)
	...
	self.plot_curves(np.array([all_returns]), ['Agent'], ['red'], 'Total Return', args.gym_id)
