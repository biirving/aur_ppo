...
class sacBulletTrainer(bulletTrainer):
    ...
    num_processes=5, pretrain_episodes=5000, bc_episodes=100, num_eval_episodes=100, track=False, batch_size=64, expert_weight=0.01,
    save_path=None, run_id=0):
        super().__init__(total_time_steps, num_env_steps, num_processes, save_path, track, run_id)
        self.agent = agent
